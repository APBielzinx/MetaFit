...
public class Main {
    public static void main(String[] args) 
    {
       ...
       alunoController.cadastrar(new Aluno("Gabriel aluno","gAluno@gmail.com","12345678",2,20,"M",40,50));
        Aluno aluno = alunoController.fazerLogin("gAluno@gmail.com","12345678");
        alunoController.atualizar(new Aluno(aluno.getId(),"Gabriel","gAluno@gmail.com","123456789",2,25,"M",40,50));
       ...
       System.out.println("Treino excluído com sucesso!");
        ...
        alunoController.cadastrar(new Aluno("Gabriel aluno treino","ga@gmail.com","12345678",2,20,"M",40,50));
